...
export const formInputTypeFirstname = document.querySelector(
  ".form__input_type_firstname"
);
export const formInputTypeProfession = document.querySelector(
  ".form__input_type_profession"
);
export const profilTitleFirstname = document.querySelector(
  ".profile__title-firstname"
);
export const profilSubtitleProfession = document.querySelector(
